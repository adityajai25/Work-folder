...
<body>
    <div class="container-sm">
        ...
        <div id="myDIV" class="box">
            ...
            <button onclick="window.location.href ='http://localhost:8080/add-client/acceptedverify.php';" class="btn current"> Verified Clients </button>
            <button onclick="window.location.href ='http://localhost:8080/add-client/pendingreq.php';" class="btn"> Pending Requests </button>
        </div>
